% LPOPT Linear programming via the simplex method.
...
function [x,lambda,inform,iter,istate] = lpopt(A,l,u,c,x0,istate0)

if ( nargin == 6 )
    [x,lambda,inform,iter,istate] = lpoptcmex(0,A,l,u,c,x0,istate0);
else
    [x,lambda,inform,iter,istate] = lpoptcmex(0,A,l,u,c,x0);
end
