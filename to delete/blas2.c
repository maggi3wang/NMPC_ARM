/* ../src/blas2.f -- translated by f2c (version 19980913).
	...
	doublereal *beta, doublereal *y, integer *incy, ftnlen trans_len)
{
    ...
    extern /* Subroutine */ int f06aaz_(char *, integer *, ftnlen);
    integer ix, iy, jx, jy, kx, ky;

/*     MARK 13 RE-ISSUE. NAG COPYRIGHT 1988. */
/*     Modified by PEG 8/31/94. */
/*     .. Entry Points .. */
/*     ENTRY      F06PAF( TRANS, M, N, ALPHA, A, LDA, X, INCX, */
/*    $                   BETA, Y, INCY ) */
/*     .. Scalar Arguments .. */
/*     .. Array Arguments .. */
/*     .. */
...
/*     Test the input parameters. */
    ...
    if (info != 0) {
	f06aaz_("dgemv/f06paf ", &info, (ftnlen)13);
	return 0;
    }
...
/*     Modified by PEG 8/31/94. */
/*     .. Entry Points .. */
/*     ENTRY      F06PMF( M, N, ALPHA, X, INCX, Y, INCY, A, LDA ) */
/*     .. Scalar Arguments .. */
/*     .. Array Arguments .. */
/*     .. */
...
/*     Test the input parameters. */
    ...
    if (info != 0) {
	f06aaz_("dger/f06pmf  ", &info, (ftnlen)13);
	return 0;
    }
...
/*     Modified by PEG 8/31/94. */
/*     .. Entry Points .. */
/*     ENTRY      F06PCF( UPLO, N, ALPHA, A, LDA, X, INCX, */
/*    $                   BETA, Y, INCY ) */
/*     .. Scalar Arguments .. */
/*     .. Array Arguments .. */
/*     .. */
...
/*     Test the input parameters. */
    ...
    if (info != 0) {
	f06aaz_("dsymv/f06pcf ", &info, (ftnlen)13);
	return 0;
    }
...
/*     Modified by PEG 8/31/94. */
/*     .. Entry Points .. */
/*     ENTRY      F06PPF( UPLO, N, ALPHA, X, INCX, A, LDA ) */
/*     .. Scalar Arguments .. */
/*     .. Array Arguments .. */
/*     .. */
...
/*     Test the input parameters. */
    ...
    if (info != 0) {
	f06aaz_("dsyr/f06ppf  ", &info, (ftnlen)13);
	return 0;
    }
...
/*     Modified by PEG 8/31/94. */
/*     .. Entry Points .. */
/*     ENTRY      F06PFF( UPLO, TRANS, DIAG, N, A, LDA, X, INCX ) */
/*     .. Scalar Arguments .. */
/*     .. Array Arguments .. */
/*     .. */
...
/*     Test the input parameters. */
    ...
    if (info != 0) {
	f06aaz_("dtrmv/f06pff ", &info, (ftnlen)13);
	return 0;
    }
...
/*     Modified by PEG 8/31/94. */
/*     .. Entry Points .. */
/*     ENTRY      F06PJF( UPLO, TRANS, DIAG, N, A, LDA, X, INCX ) */
/*     .. Scalar Arguments .. */
/*     .. Array Arguments .. */
/*     .. */
...
/*     Test the input parameters. */
    ...
    if (info != 0) {
	f06aaz_("dtrsv/f06pjf ", &info, (ftnlen)13);
	return 0;
    }
